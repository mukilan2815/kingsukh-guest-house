...
const Contact = () => {
  return (
    <section className=" bg-[#222]" id="contact">
      <div
        id="map"
      ...
      <div className="container px-6 md:px-12">
        <div className="block rounded-lg bg-[#333] px-6 py-12 shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)]  md:py-16 md:px-12 -mt-[100px] backdrop-blur-[30px] border">
                ...
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-sm text-neutral-500">972244914</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                  <div className="flex items-start">
                    ...
                    <div className="ml-6 grow">
                      <p className="mb-2 font-bold text-white">Room Service</p>

                      <p className="text-sm text-neutral-500">976432574</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-sm text-neutral-500">723961532</p>
                    </div>
                  </div>
                </div>
                <div className="mb-12 w-full shrink-0 grow-0 basis-auto md:w-6/12 md:px-3 lg:w-full lg:px-6 xl:w-6/12">
                  <div className="align-start flex">
                    ...
                    <div className="ml-6 grow">
                      ...
                      <p className="text-sm text-neutral-500">941673298</p>
                    </div>
                  </div>
                </div>
              </div>
